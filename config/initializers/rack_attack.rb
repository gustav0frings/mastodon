...
class Rack::Attack
  ...
  throttle('throttle_authenticated_api', limit: 999_999, period: 5.minutes) do |req|
    req.authenticated_user_id if req.api_request?
  end

  throttle('throttle_per_token_api', limit: 999_999, period: 5.minutes) do |req|
    req.authenticated_token_id if req.api_request?
  end

  throttle('throttle_unauthenticated_api', limit: 5_000, period: 5.minutes) do |req|
